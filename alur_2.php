...
<head>
  ...
  <link rel="stylesheet" href="alur2.css">
  ...
  <!-- about -->
        <div class="container">
         <div class="about">
            ...
            <P>Lorem ipsum dolor sit amet consectetur<strong> adipisicing elit. Minus reiciendis sed, cum quisquam soluta </strong>unde beatae autem repellendus error sit? Asperiores exercitationem quaerat ipsum dolorem deleniti rerum culpa officia consectetur?Lorem ipsum dolor sit, amet consectetur adipisicing elit. Deleniti odio quibusdam fuga exercitationem illum consequatur, iste voluptatibus qui consequuntur quis alias laborum nam officia perferendis natus distinctio eius dignissimos! Perspiciatis?Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi eaque mollitia, aut inventore et numquam voluptates quidem expedita molestias culpa provident ab, assumenda perspiciatis totam sint, labore praesentium voluptatum nihil.</P>
         </div>
       </div>
               <!-- akhr container box -->
              </div>
            ...
            sudah memiliki pengalaman di bidang pembuatan roti sejak tahun 1986 dengan merek Roti GARDENIA. Dalam proses produksi pembuatan roti <strong>Primebread</strong> sudah menggunakan mesin canggih agar mempermudah operator dan mempercepat produksi untuk hasil yang maksimal.</P>
                ...
                <div class="page">
                  <h2>Page</h2>
                  <ul>
                    <li><a href="alur.php">1</a></li>
                    <li class="active"><a href="alur_2.php">2</a></li>
                    <li class=""><a href="alur_3.php">3</a></li>
